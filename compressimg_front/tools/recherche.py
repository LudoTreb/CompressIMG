...
# essai avec class
# class ManipulateImage(Image.Image):
#     def __init__(self, img_file):
#         self.img = Image.open(img_file)

#     def display_data(self):
#         print(f"Data : dimension:{self.img.size}, format:{self.img.format}")

#     def scale_img(self, data_input):
#         scale_factor = data_input["img_converted_scale"] / 100

#         new_img_width = int(self.img.width * scale_factor)
#         new_img_height = int(self.img.height * scale_factor)
...
# img = ManipulateImage(mon_image)

# img.display_data()


# img.scale_img(user_data_input)
# img.display_data()
...
print(img_compressed.size, img_compressed.format)
